...
:: Android packaging
set AND_CERT_NAME="RL2_Mobile"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\RL2Mobile.p12
...
set IOS_PROVISION=cert\RL2Mobile.mobileprovision
...
set APP_ID=air.RL2Mobile

:: Output packages
set DIST_PATH=dist
set DIST_NAME=RL2Mobile
